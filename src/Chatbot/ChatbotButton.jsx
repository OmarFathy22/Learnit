...
const ChatbotButton = () => {
  ...
  return (
    <>
      <div
        className=" fixed bottom-[70px] max-600:bottom-[30px] max-600:right-[30px] right-[70px] bg-blue-400 p-4 rounded-full cursor-pointer transition duration-300 hover:bg-blue-300"

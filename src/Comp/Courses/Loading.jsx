                ...
                <Box sx={{ pr: 2, mt: 2 }}>
                  ...
                  {user && loadingEnroll ? (
                    ...
                    <h6 className="flex text-green-500  items-center gap-[5px]">
                      {checkEnrolled(item?.id) ? <h6 className="flex text-green-500 mt-1 items-center gap-[5px]"><FaUserCheck/>Enrolled</h6> : <h6 className="mt-1 text-blue-500">{item?.price}$</h6>}
                    </h6>
                  )}
                </Box>
              ) : (

...
const SvgButton = React.forwardRef(function SvgButton(props, ref) {
  return <Button onClick={props.handleOpen}  {...props} slots={{ root: CustomButtonRoot }} ref={ref} />;
});

export default function UnstyledButtonCustom({handleOpen}) {
  return <SvgButton handleOpen={handleOpen}>Sign in</SvgButton>;
}
